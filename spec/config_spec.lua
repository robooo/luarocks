...
describe("LuaRocks config tests #blackbox #b_config", function()
   ...
   describe("LuaRocks config - more complex tests", function()
      it("LuaRocks fail system config", function()
         ...
         os.rename(testing_paths.testing_lrprefix .. "/etc/luarocks/config.lua", testing_paths.testing_lrprefix .. "/etc/luarocks/config_temp.lua")
         assert.is_false(run.luarocks_bool("config --system-config"))
         os.rename(testing_paths.testing_lrprefix .. "/etc/luarocks/config_temp.lua", testing_paths.testing_lrprefix .. "/etc/luarocks/config.lua")
      end)
